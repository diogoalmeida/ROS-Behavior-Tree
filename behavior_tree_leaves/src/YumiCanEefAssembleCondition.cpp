...
void CanEefAssembleCondition::executeCB(const behavior_tree_core::BTGoalConstPtr &goal)
{
    bool success;
    success = yumi_->isAssemblable(eef_);
...
void CanEefAssembleCondition::setStatus(int status){
