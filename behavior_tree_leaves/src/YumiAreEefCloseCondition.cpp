...
void AreEefCloseCondition::executeCB(const behavior_tree_core::BTGoalConstPtr &goal)
{
    bool success;
    success = yumi_->isClose(LEFT, RIGHT);
...
void AreEefCloseCondition::setStatus(int status){
