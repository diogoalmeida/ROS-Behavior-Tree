#ifndef __YUMI_TRANSFER_ACTION__
#define __YUMI_TRANSFER_ACTION__
#include <ros/ros.h>
...
public:
  TransferAction(std::string name, int eef, vrep_ros_interface::Yumi *yumi) :
    as_(nh_, name, boost::bind(&TransferAction::executeCB, this, _1), false),
    action_name_(name)
  {
