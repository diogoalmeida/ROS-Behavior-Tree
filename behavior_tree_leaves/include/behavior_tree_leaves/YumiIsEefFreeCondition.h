#ifndef __YUMI_IS_EEF_FREE_CONDITION__
#define __YUMI_IS_EEF_FREE_CONDITION__
#include <ros/ros.h>
...
public:
  IsEefFreeCondition(std::string name, int eef, vrep_ros_interface::Yumi *yumi) :
    as_(nh_, name, boost::bind(&IsEefFreeCondition::executeCB, this, _1), false),
