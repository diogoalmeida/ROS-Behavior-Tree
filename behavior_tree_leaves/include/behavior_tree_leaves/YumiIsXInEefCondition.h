#ifndef __YUMI_IS_X_IN_EEF_CONDITION__
#define __YUMI_IS_X_IN_EEF_CONDITION__
#include <ros/ros.h>
...
public:
  IsXInEefCondition(std::string name, std::string object_name, int eef, vrep_ros_interface::Yumi *yumi) :
    as_(nh_, name, boost::bind(&IsXInEefCondition::executeCB, this, _1), false),
