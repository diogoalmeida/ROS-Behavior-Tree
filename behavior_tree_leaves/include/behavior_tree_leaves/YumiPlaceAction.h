#ifndef __YUMI_PLACE_ACTION__
#define __YUMI_PLACE_ACTION__
#include <ros/ros.h>
...
protected:
  ...
  std::string action_name_, place_target_;
...
public:
  PlaceAction(std::string name, std::string place_target, vrep_ros_interface::Yumi *yumi) :
    as_(nh_, name, boost::bind(&PlaceAction::executeCB, this, _1), false),
    action_name_(name), place_target_(place_target)
  {
