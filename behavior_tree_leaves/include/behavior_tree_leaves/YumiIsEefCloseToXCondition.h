#ifndef __YUMI_IS_EEF_CLOSE_TO_X_CONDITION__
#define __YUMI_IS_EEF_CLOSE_TO_X_CONDITION__
#include <ros/ros.h>
...
public:
  IsEefCloseToXCondition(std::string name, int eef, std::string object_name, vrep_ros_interface::Yumi *yumi) :
    as_(nh_, name, boost::bind(&IsEefCloseToXCondition::executeCB, this, _1), false),
